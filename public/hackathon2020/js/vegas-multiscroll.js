...
$(document).ready(function(){
    ...
    $('.slideshow-home-left').vegas({
        slides: [
            { src: '/hackathon2020/img/left-1.jpg' },
            { src: '/hackathon2020/img/left-2.jpg' },
            { src: '/hackathon2020/img/left-3.jpg' },
        ],
    ...
    $('.slideshow-home-right').vegas({
        slides: [
            { src: '/hackathon2020/img/right-1.jpg' },
            { src: '/hackathon2020/img/right-2.jpg' },
            { src: '/hackathon2020/img/right-3.jpg' },
        ],
    ...
    $('.slideshow-about').vegas({
        slides: [
            { src: '/hackathon2020/img/slide-1.jpg' },
            { src: '/hackathon2020/img/slide-2.jpg' },
            { src: '/hackathon2020/img/slide-3.jpg' },
        ],
